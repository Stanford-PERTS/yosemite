...
jQuery(document).ready(function($) {
	...
	/* MixPanel */
	$('#about #main-nav li.main-level:nth-child(2)').click(function() {
		mixpanel.track("About Us");
	});
	
	
	$('#home #main-nav li.main-level:nth-child(1)').addClass('current');
	$('#about #main-nav li.main-level:nth-child(2)').addClass('current');
	$('#programs #main-nav li.main-level:nth-child(3)').addClass('current');
	$('#contact #main-nav li.main-level:nth-child(4)').addClass('current');
